...
Entry::Entry(size_t docId, size_t count) :
        m_docId(docId), m_count(count) {}
...
void InvertedIndex::getTermFrequencyFromText(const std::string &text, const int textId) {
    std::string word;
